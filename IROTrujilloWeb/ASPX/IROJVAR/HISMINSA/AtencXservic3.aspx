<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="AtencXservic3.aspx.cs" Inherits="ASPX_IROJVAR_HISMINSA_AtencXservic3" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DetProfesional(vanio, vmes, vcodserv, vservicio) {
            ...
            $("#divAtencion").html("");
            $.ajax({
                type: "POST", url: "AtencXservic3.aspx/GetDetProfesional", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) {
                    var aResult = result.d.split("||sep||");
                    $("#divmod01").html(aResult[1]);
        ...
        function fXservXprofXdia(vanio, vmes, vdia, vcodserv, vservicio, vcodplaza) {
            ...
            $.ajax({
                type: "POST", url: "AtencXservic3.aspx/GetDetServXProfXDia", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { 
            ...
            <div class="row" style="display:block;">
                     ...
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="DDLMes" runat="server" class='form-control'>
                              <asp:ListItem Value="0" Selected="true">Todos los Meses</asp:ListItem>
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="ddlServicio" runat="server" class='form-control' AutoPostBack="True" OnSelectedIndexChanged="ddlServicio_SelectedIndexChanged" >
                            <asp:ListItem Value="">Todos</asp:ListItem>
                            <asp:ListItem Value="TodosServicios">Todos los Servicios</asp:ListItem>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulHISMAtenServ").classList.add('active');
        var f = new Date();
