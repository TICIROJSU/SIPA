<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="AtencXservic4.aspx.cs" Inherits="ASPX_IROJVAR_HISMINSA_AtencXservic4" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DetAtenCli(vanio, vmes, vdia, vcodserv, vservicio, vcodplaza) {
            ...
            $.ajax({
                type: "POST", url: "AtencXservic4.aspx/GetDetAtenCli", data: params, 
        ...
        function DetProfesional(vanio, vmes, vcodserv, vservicio, vmesHasta) {
            var params = new Object();
            params.vanio = vanio; 
            params.vmes = vmes; 
            params.vcodserv = vcodserv; 
            params.vservicio = vservicio; 
            params.vmesHasta = vmesHasta; 
            params = JSON.stringify(params);

            $("#divAtencion").html("");
            $.ajax({
                type: "POST", url: "AtencXservic4.aspx/GetDetProfesional", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fXservXprofXdia(vanio, vmes, vdia, vcodserv, vservicio, vcodplaza) {
            ...
            $.ajax({
                type: "POST", url: "AtencXservic4.aspx/GetDetServXProfXDia", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { 
