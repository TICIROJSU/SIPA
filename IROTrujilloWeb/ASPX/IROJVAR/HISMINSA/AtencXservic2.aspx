<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="AtencXservic2.aspx.cs" Inherits="ASPX_IROJVAR_HISMINSA_AtencXservic2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Reporte de Atenciones por Servicio</p>
    </div>
</asp:Content>
...
<div class="row">
	<div class="col-lg-3 col-xs-6" data-toggle='modal' data-target='#modalDetRecaudacion' onclick="fDetRecaudacion('1')">
	  <div class="small-box bg-aqua">
		<div class="inner"><h3><asp:Literal ID="LitTAten" runat="server">0</asp:Literal></h3>
	...
	<!-- ./col -->
	<div class="col-lg-3 col-xs-6" data-toggle='modal' data-target='#modalDetRecaudacion' onclick="fDetRecaudacion('2')">
	  <div class="small-box bg-green">
		<div class="inner"><h3><asp:Literal ID="LitASIS" runat="server">0</asp:Literal></h3>
            <p>Atenciones SIS</p>
		</div>
	...
	<!-- ./col -->
	<div class="col-lg-3 col-xs-6" data-toggle='modal' data-target='#modalDetRecaudacion' onclick="fDetRecaudacion('3')">
	  <div class="small-box bg-yellow">
		<div class="inner"><h3><asp:Literal ID="LitAUsu" runat="server">0</asp:Literal></h3>
            <p>Atenciones de Usuario</p>
		</div>
		<div class="icon"><i class="ion ion-person-add"></i></div>
	  </div>
	</div>
	<!-- ./col -->
	<div class="col-lg-3 col-xs-6" data-toggle='modal' data-target='#modalDetRecaudacion' onclick="fDetRecaudacion('4')">
	  <div class="small-box bg-red">
		<div class="inner"><h3><asp:Literal ID="LitAExo" runat="server">0</asp:Literal></h3>
            <p>Atenciones Exon</p>
		</div>
		<div class="icon"><i class="ion ion-ios-medkit"></i></div>
	  </div>
	</div>
	<!-- ./col -->
</div>
