<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="HISEnvio.aspx.cs" Inherits="ASPX_IROJVAR_HISMINSA_HISEnvio" %>
            ...
            <div class="row" style="display:block;">
               ...
               <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:LinkButton ID="bntBuscar" runat="server" class="btn btn-success" OnClick="bntBuscar_Click" ><i class="fa fa-search"></i> Generar JSON Previo</asp:LinkButton>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulHISEnvio").classList.add('active');
        var f = new Date();
