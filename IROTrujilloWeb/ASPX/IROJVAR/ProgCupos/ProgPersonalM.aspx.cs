...
public partial class ASPX_IROJVAR_ProgCupos_ProgPersonalM : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string SetBtnGuardar(string idProgServ, string COD_SER, string Cod_Per, string PIS_SER, string Tur_Ser, string PPAnio, string PPMes, string PPFechaCupos, string PPCupos, string PPAdiLimite, string Hr_Ser, string PPObservacion, string PPEstado, string PPTipTrabajo)
    {
        ...
        try
        {
            qSql = "INSERT INTO TabLibres.dbo.ProgPer (idProgServ, COD_SER, Cod_Per, PIS_SER, Tur_Ser, PPAnio, PPMes, PPFechaCupos, PPCupos, PPAdicional, PPAdiLimite, Hr_Ser, PPObservacion, PPEstado, PPTipTrabajo) VALUES (@idProgServ, @COD_SER, @Cod_Per, @PIS_SER, @Tur_Ser, @PPAnio, @PPMes, @PPFechaCupos, @PPCupos, @PPAdicional, @PPAdiLimite, @Hr_Ser, @PPObservacion, @PPEstado, @PPTipTrabajo) SELECT @@Identity;";
