<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="ProcVenta.aspx.cs" Inherits="ASPX_IROJVAR_Optica_ProcVenta" %>
    ...
    <script language="javascript" type="text/javascript">
		...
		function btnbuscar0() {
			if (document.getElementById("divFDesde").style.visibility=="visible") {
				...
				document.getElementById("divChkVerTodo").style.visibility="hidden";
			}
			else {
				...
				document.getElementById("divChkVerTodo").style.visibility="visible";
			}
		}
		...
		function buscarNIng() {
			...
			$.ajax({
                type: "POST", url: "ProcVenta.aspx/GetNIngresoList", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function gSelNIng(vpacdni, vpacnom, vOTfec, vOTcod, vOTmont) {
			document.getElementById("<%=txtDNIPaciente.ClientID%>").value = vpacdni;
			document.getElementById("<%=txtNombrePaciente.ClientID%>").value = vpacnom;
			document.getElementById("txtOTCodigo").value = vOTcod;
			<%--document.getElementById("<%=txtFechaEmi.ClientID%>").value = vfec;--%>

            vSubtotal = Math.round(vOTmont / 1.18 * 100) / 100;
            vIGV = Math.round((vOTmont - vSubtotal) * 100) / 100;
            document.getElementById("<%=txtMontoTotal.ClientID%>").value = vOTmont;
            document.getElementById("<%=txtSubTotal.ClientID%>").value = vSubtotal;
            document.getElementById("<%=txtIGV.ClientID%>").value = vIGV;
		...
		function gSelNIngDet(vcod) {
			...
			$.ajax({
                type: "POST", url: "ProcVenta.aspx/GetNIngresoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Optica - Ventas</p>
    </div>
</asp:Content>
				...
				<div class="column">
					<div class="col-md-8" style="padding:  0px 30px 10px 30px; ">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<asp:dropdownlist ID="DDLTipoDoc" runat="server" class='form-control'>
									<asp:ListItem Value="BOLETA" Selected="true">BOLETA</asp:ListItem>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<asp:TextBox ID="txtDNIPaciente" runat="server" class='form-control'></asp:TextBox>
					...
					<div class="col-md-4" style="padding:  0px 30px 10px 30px; ">
						...
						<div class="row">
							<div class="col-md-4" style="display:block">
								<input type="text" id="txtOTCodigo" class='form-control' />
								<code style="color:black; background-color:transparent">Ord. Trabajo</code>
							</div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulLiOptProcVenta").classList.add('active');
        var f = new Date();
