<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="MantProductos.aspx.cs" Inherits="ASPX_IROJVAR_Optica_MantProductos" %>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulLiOptMantProd").classList.add('active');
        var f = new Date();
