...
public partial class ASPX_IROJVAR_Optica_ProcVenta : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dtDatoDetAt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dbRow in dtDatoDetAt.Rows)
                {
                    ...
                    vfprod += vpro + " (" + vmontura + ") [" + vcant + "] " + "</br>";
                    vftotal += Convert.ToDouble(vimp);
                }

                gHTML += "<tr>";
                gHTML += "<td class='' >1</td>";
                gHTML += "<td style='text-align: left;' >" + vfprod + "</td>";
                gHTML += "<td style='text-align: left;' >" + vftotal + "</td>";
                gHTML += "<td style='text-align: left;' >" + vftotal + "</td>";
                gHTML += "</tr>";
                gHTML += Environment.NewLine;
