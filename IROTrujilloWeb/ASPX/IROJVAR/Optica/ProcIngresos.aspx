<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="ProcIngresos.aspx.cs" Inherits="ASPX_IROJVAR_Optica_ProcIngresos" %>
   ...
   <title>Optica</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function buscarProv() {
            ...
            $.ajax({
                type: "POST", url: "ProcIngresos.aspx/GetbuscarPac", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnNuevo() {
			window.location.href = '../../IROJVAR/Optica/ProcIngresos.aspx';
		}
		...
		function btnGuardarCab() {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetBtnGuardar", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnGuardarDet(idming, IDProd, CodMontura, Cantidad, Precio, Importe, IdProdDet) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetBtnGuardarDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoDet(IdProdDet, CodProd, CodMontura, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetstkProductoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function ProductosOptica(CodProd, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetProductosOptica", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoAlmacen(idDestino, CodProd, IdProdDet, Cantidad) {
			...
			//
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetstkProductoAlmacen", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function compruebaIdMontura(nroitem, IDProd) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetCompruebaMontura", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
		...
		function GeneraIdMontura(IDProd, codmontura, nroitem) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/SetGeneraIdMontura", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
					document.getElementById("txtIdMont_" + nroitem).value = result.d;
				}, 
		...
		function buscarNIng() {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/GetNIngresoList", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function gSelNIngDet(vcod) {
			...
			$.ajax({
                type: "POST", url: "ProcIngresos.aspx/GetNIngresoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulLiOptProcIngre").classList.add('active');
        var f = new Date();
