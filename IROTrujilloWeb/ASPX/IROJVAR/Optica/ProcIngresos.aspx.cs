...
public partial class ASPX_IROJVAR_Optica_ProcIngresos : System.Web.UI.Page
{
		...
		try
		{
			...
			if (dtDatoDetAt.Rows.Count > 0)
			{
				...
				foreach (DataRow dbRow in dtDatoDetAt.Rows)
				{
					...
					gHTML += "<td style='text-align: left;' ><input type='text' name='txtIdMont_" + nroitem + "' id='txtIdMont_" + nroitem + "' class='form-control input-lg' ></td>";
