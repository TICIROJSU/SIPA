<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="Recaudacion.aspx.cs" Inherits="ASPX_IROJVAR_Optica_Recaudacion" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fDetRecaudacion(vmes, vanio, vtotal, vservicio) {
            ...
            $.ajax({
                type: "POST", url: "Recaudacion.aspx/GetDetRecaudacion", data: params, 
        ...
        function fDetRecaudacion2(vanio, vmes, vdia, vtotal) {
            ...
            $.ajax({
                type: "POST", url: "Recaudacion.aspx/GetDetRecaudacion2", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
         ...
         <section class="content">
            ...
            <div class="row" style="display:block;">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group invisible" data-toggle="modal" data-target="#modalShowProf" onclick="fShowProf()">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group has-success" >
                            <asp:TextBox ID="txtPorCobrar" runat="server" Text="" class='form-control input-lg' ReadOnly="True" style='text-align:center'></asp:TextBox>
                            <code>Por Cobrar</code>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulOpticaRep").classList.add('active');
        var f = new Date();
