<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="Atenciones.aspx.cs" Inherits="ASPX_IROJVAR_UPE_Atenciones" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DetAtenciones(vanio, vmes, vcodserv, vservicio) {
            ...
            $("#divAtencion").html("");
            $.ajax({
                type: "POST", url: "ssssssssss.aspx/GetDetAtenciones", data: params, 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">UPE - Atenciones </p>
    </div>
</asp:Content>
...
<script>
            ...
            <!--FIN TERCERA FILA-->
             ...
             <div class="row">
                 <div class="col-md-12">
                     <iframe width="100%" height="750" src="https://lookerstudio.google.com/embed/reporting/c20803ec-46eb-47b5-b988-7a24f7996061/page/QhQrD" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>
                 </div>
             </div>
