<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ASPX_IROJVAR_Sorteo2_Default" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script language="javascript" type="text/javascript">
        ...
        window.location.href = '../Sorteo202312';
...
<body>
	...
	<div class="portada">
		<div id="desarrollofrontend">
		   ...
		   <h1>Bienvenidos al sorteo </h1>
		</div>
		
		<div>		  
				<div onclick="fShowSorteados()">
					<img src="boton-jugar.png">
				</div>
		</div>  
