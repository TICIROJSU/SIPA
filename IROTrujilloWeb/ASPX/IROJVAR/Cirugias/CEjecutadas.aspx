<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="CEjecutadas.aspx.cs" Inherits="ASPX_IROJVAR_Cirugias_CEjecutadas" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fEspeMes(vanio, vmes, vmesnom, vfila) {
            ...
            $.ajax({
                type: "POST", url: "CEjecutadas.aspx/GetDetEspecialidadxMes", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fPacEspeMes(vanio, vmes, vmesnom, vespec, vfila) {
            ...
            $.ajax({
                type: "POST", url: "CEjecutadas.aspx/GetDetPacientexEspexMes", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { 
                    var aResult = result.d.split("||sep||");
