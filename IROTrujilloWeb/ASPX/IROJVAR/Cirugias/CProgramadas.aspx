<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="CProgramadas.aspx.cs" Inherits="ASPX_IROJVAR_Cirugias_CProgramadas" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DetAtenciones(vanio, vmes, vcodserv, vservicio) {
            ...
            $("#divAtencion").html("");
            $.ajax({
                type: "POST", url: "CProgramadas.aspx/GetDetAtenciones", data: params, 
        ...
        function fEspeMes(vanio, vmes, vmesnom, vfila) {
            ...
            $.ajax({
                type: "POST", url: "CProgramadas.aspx/GetDetEspecialidadxMes", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fPacEspeMes(vanio, vmes, vmesnom, vespec, vfila) {
            $("#divTblPaciente").html("");
            ...
            $.ajax({
                type: "POST", url: "CProgramadas.aspx/GetDetPacientexEspexMes", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { 
                    var aResult = result.d.split("||sep||");
