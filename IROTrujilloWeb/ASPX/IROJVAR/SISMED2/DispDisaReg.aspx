<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="DispDisaReg.aspx.cs" Inherits="ASPX_IROJVAR_SISMED2_DispDisaReg" %>
            ...
            return false;
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:DropDownList ID="ddlRed" runat="server" class='form-control' AppendDataBoundItems="true" onchange="ddlSel1('ContentPlaceHolder2_ddlSSO'); fBscTblHTML('ContentPlaceHolder2_ddlRed', 'ContentPlaceHolder2_GVtable', 3); " >
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:DropDownList ID="ddlSSO" runat="server" class='form-control' AppendDataBoundItems="true" onchange="ddlSel1('ContentPlaceHolder2_ddlRed'); fBscTblHTML('ContentPlaceHolder2_ddlSSO', 'ContentPlaceHolder2_GVtable', 31); " >
                                <asp:ListItem Value="">Todos</asp:ListItem>
                            </asp:DropDownList>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulDispoDisas").classList.add('active');
        var f = new Date();
