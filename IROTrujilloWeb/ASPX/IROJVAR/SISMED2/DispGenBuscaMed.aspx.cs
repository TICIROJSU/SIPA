...
public partial class ASPX_IROJVAR_SISMED2_DispGenBuscaMed : System.Web.UI.Page
{
    ...
    public void CargaTablaDT()
    {
        ...
        {
            //con.Open();
            string qSql = "select Red, CodES, Establecimiento, CodMed, Medicamento, FF, " +
                "Mes01, Mes02, Mes03, Mes04, Mes05, Mes06, Mes07, Mes08, Mes09, Mes10, Mes11, Mes12, " +
                "cast(ConsProm as decimal(18,2)) as ConsProm, Stock, CAST(Stock_Mes as decimal(18,2)) as Stock_Mes, SSO " +
                "from SISMED.dbo.Disp " +
                "where CodMed + Medicamento like '%' + @Dato + '%' " +
                "order by Red, Stock desc ";
