...
public partial class ASPX_IROJVAR_Sorteo202312_Default : System.Web.UI.Page
{
    ...
    public static string GetSorteado(string IntentosCant)
    {
        ...
        try
        {
            string qSql = "select top 1 *, Nombre AS Personal from Prueba.dbo.RegistroSorteo202312 " +
                "where Sorteo = '0' AND SorteoFiltro = 'SI' ORDER BY NEWID() ";
        ...
        if (vMensaje == "Ganador")
        {
            ...
            {
                //con.Open();
                string consql = "UPDATE Prueba.dbo.RegistroSorteo202312 SET Sorteo = @Sorteo WHERE idPerSorteo = @idPerSorteo; ";
    ...
    public void CargaInicial()
    {
        ...
        {
            //con.Open();
            string qSql = "Select ROW_NUMBER() OVER(ORDER BY idPerSorteo) Nro, Nombre Personal, Sorteo Mensaje from Prueba.dbo.RegistroSorteo202312 where Sorteo <> '0' order by 1 desc; ";
