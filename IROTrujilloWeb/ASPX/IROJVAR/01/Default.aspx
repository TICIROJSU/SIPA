<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ASPX_IROJVAR_01_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
   <form id="form1" runat="server">
    ...
    <script>
        ...
        document.getElementById("LiREFCONm").classList.add('menu-open');
        document.getElementById('UlREFCONm').style.display = 'block';

        if (tip=="Tiempos") {document.getElementById("UlREFCONmTES").classList.add('active');}
        if (tip=="Diferimiento") {document.getElementById("UlREFCONmDIF").classList.add('active');}
