<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ASPX_IROJVAR_CitasProgDia_Default" %>
...
<script>
    var varMes = <%=DateTime.Now.Month - 1%>;
    var selMes = document.getElementById("<%=DDLMes.ClientID%>");
    <%
    if (!Page.IsPostBack)
    {%>
        selMes.options[varMes].defaultSelected = true;
    <%}
    %>
</script>
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="DDLGrupo" runat="server" class='form-control' >
                              <asp:ListItem Value="">Grupos</asp:ListItem>
                              <asp:ListItem Value="N">Niño</asp:ListItem>
               ...
               <div class="col-md-12">
                  <div class="box" >
                     ...
                     <div class="box-body table-responsive no-padding" id="habfiltro">
                        ...
                        <asp:Literal ID="LitTABLTarde" runat="server"></asp:Literal>
                     </div>
                     <!-- /.box-body -->
                  </div>
                  <!-- /.box -->
