<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="DisponibilidadIRO2.aspx.cs" Inherits="ASPX_IROJVAR_SISMED_DisponibilidadIRO2" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function fDetDisponibilidad(Indicador) {
            ...
            $.ajax({
                type: "POST", url: "DisponibilidadIRO2.aspx/GetDetDisponibilidad", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fShowEESS() {
            $.ajax({
                type: "POST", url: "DisponibilidadIRO2.aspx/GetEESS",  
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
