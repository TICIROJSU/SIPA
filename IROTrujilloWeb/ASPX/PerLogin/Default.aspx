<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ASPX_PerLogin_Default" %>
...
<body class="hold-transition login-page">
    <form ID="FormView1" runat="server" > <%--autocomplete="off"--%>
         ...
         <div class="login-box-body">
            <p class="login-box-msg">Inicia sesión</p>
               ...
               <div class="form-group has-feedback">
                   <asp:TextBox ID="txtusuario" runat="server" class="form-control" placeholder="DNI Usuario" required="true"></asp:TextBox>
               ...
               <div class="form-group has-feedback" style="display:block">
                   <asp:TextBox ID="txtcontrasena" runat="server" type="password" class="form-control" placeholder="Clave Usuario" required="true"></asp:TextBox>

                  <span class="glyphicon glyphicon-lock form-control-feedback"></span>
               </div>
               <div class="row">
                  <div class="col-xs-8" style="visibility:visible">
                     <%--<div class="checkbox icheck">--%>
                        
                        <%--<input type="checkbox" > Acepto los términos.--%>
                            <a class="btn btn-warning btn-block btn-flat" href="https://www.youtube.com/watch?v=xiPiCGaS0g4" target="_blank">Ver Video Tutorial</a>
