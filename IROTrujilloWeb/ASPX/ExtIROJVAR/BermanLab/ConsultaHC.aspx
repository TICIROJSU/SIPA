<%@ Page Language="C#" MasterPageFile="../../MasterPageExt.master" AutoEventWireup="true" CodeFile="ConsultaHC.aspx.cs" Inherits="ASPX_ExtIROJVAR_BermanLab_ConsultaHC" %>
                  ...
                  <div class="col-md-3" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtProd" runat="server" class='form-control' placeholder="DNI|HC" autofocus="true" ></asp:TextBox>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulHcDNI").classList.add('active');
        var f = new Date();
