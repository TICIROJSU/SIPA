<%@ Page Language="C#" MasterPageFile="../../MasterPageExt.master" AutoEventWireup="true" CodeFile="ConsultaOrden.aspx.cs" Inherits="ASPX_ExtIROJVAR_BermanLab_ConsultaOrden" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Consulta Ordenes Realizadas</p>
    </div>
</asp:Content>
                  ...
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <div class="input-group" onclick="chkVerTodoCHK()">
	                            <span class="input-group-addon">
                                    <asp:CheckBox ID="chkVerTodo" runat="server" />
	                            </span>
                                <asp:Label ID="Label1" runat="server" Text="Ver Todo" class="form-control"></asp:Label>
                            </div>
                        </div>
                     </div>
                  </div>
...
<%--	var inputText = document.getElementById("<%=txtProd.ClientID%>");
    ...
    function chkVerTodoCHK() {
        document.getElementById("<%=chkVerTodo.ClientID%>").checked = !document.getElementById("<%=chkVerTodo.ClientID%>").checked;
    }
</script>
            ...
            <div class="input-group margin">
                            ...
                            <div><input type="text" class="form-control" id="bscprod2" placeholder="Buscar" onkeyup="fBscTblHTML('bscprod2', '<%=GVtable.ClientID%>', 5)" autofocus="autofocus">
                            </div>
            </div>
                            </h3>
    ...
    <script>
        ...
        document.getElementById("LiBermanLab").classList.add('menu-open');
        document.getElementById('UlBermanLab').style.display = 'block';
        document.getElementById("ulConsOrden").classList.add('active');
        var f = new Date();
