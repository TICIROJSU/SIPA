<%@ Page Language="C#" MasterPageFile="../../MPFotos.master" AutoEventWireup="true" CodeFile="FOxDisminucionVis.aspx.cs" Inherits="ASPX_ExtIROJVAR_Foto_FOxDisminucionVis" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Disminucion de vision al menos un ojo debido a la RD</p>
    </div>
</asp:Content>
