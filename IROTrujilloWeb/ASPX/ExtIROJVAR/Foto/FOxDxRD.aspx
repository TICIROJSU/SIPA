<%@ Page Language="C#" MasterPageFile="../../MPFotos.master" AutoEventWireup="true" CodeFile="FOxDxRD.aspx.cs" Inherits="ASPX_ExtIROJVAR_Foto_FOxDxRD" %>
      ...
      white-space: nowrap; 
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="col-md-12 hide">
                            <asp:Literal ID="LitGraf2" runat="server"></asp:Literal>
                        </div>                        
                    </div>
