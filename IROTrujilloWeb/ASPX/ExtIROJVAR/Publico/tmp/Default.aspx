<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="DevelopmentWithADot.AspNetSpeechSynthesizer.Test.Default" %>
<%--<%@ Register Assembly="DevelopmentWithADot.AspNetSpeechSynthesizer.Test" Namespace="DevelopmentWithADot.AspNetSpeechSynthesizer.Test" tagPrefix="web" %>--%>
