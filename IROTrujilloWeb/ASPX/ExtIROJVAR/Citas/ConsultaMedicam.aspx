<%@ Page Language="C#" MasterPageFile="../../MasterPageExtPac.master" AutoEventWireup="true" CodeFile="ConsultaMedicam.aspx.cs" Inherits="ASPX_ExtIROJVAR_Citas_ConsultaMedicam" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Consulta de Medicamentos - Asistencial</p>
    </div>
</asp:Content>
            ...
            <div class="row hide" style="display:block;">
                  ...
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            ...
                            <code style="font-size:large; background-color:transparent; ">Numero de DNI</code>
                        </div>
                     </div>
                  </div>
                </div>
                <div class="column">
                    <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                        <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtProd" runat="server" class='form-control' Type="date" placeholder="dd/mm/aaaa"></asp:TextBox>
                            <code style="font-size:large; background-color:transparent; ">Fecha Nacimiento</code>
                        </div>
                        </div>
                    </div>
                </div>    
            ...
            <div class="row" style="display:block;">
                ...
                <div class="column">
                    <div class="col-md-4" style="text-align: center;padding:  0px 30px 0px 30px;">
                        <div class="box-body">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlCategoria" runat="server" class='form-control' AppendDataBoundItems="true" onchange="ddlSel1('ContentPlaceHolder2_ddlServicio2'); fBscTblHTML('ContentPlaceHolder2_ddlCategoria', 'tblbscrJS', 1)">
                                </asp:DropDownList>
                                <code style="background-color:transparent; ">Categoria</code>
                            </div>
                        </div>
                    </div>
                </div>    
                ...
                <div class="column hide">
                    <div class="col-md-4" style="text-align: center;padding:  0px 30px 0px 30px;">
                        <div class="box-body">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlServicio" runat="server" class='form-control' AppendDataBoundItems="true" onchange="ddlSel1('ContentPlaceHolder2_ddlCategoria'); fBscTblHTML('ContentPlaceHolder2_ddlServicio', 'tblbscrJS', 2); ">
                                </asp:DropDownList>
                                <code style="background-color:transparent; ">Servicio</code>
                            </div>
                        </div>
                    </div>
                </div>   
                ...
                <div class="column">
                    <div class="col-md-4" style="text-align: center;padding:  0px 30px 0px 30px;">
                        <div class="box-body">
                            <div class="form-group">
                                <asp:DropDownList ID="ddlServicio2" runat="server" class='form-control' AppendDataBoundItems="true" onchange="ddlSel1('ContentPlaceHolder2_ddlCategoria'); fBscTblHTML('ContentPlaceHolder2_ddlServicio2', 'tblbscrJS', 2); ">
                                </asp:DropDownList>
                                <code style="background-color:transparent; ">Servicio</code>
                            </div>
                        </div>
