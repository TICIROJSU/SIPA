...
public partial class ASPX_ExtIROJVAR_Citas_ConsultaCitaPac : System.Web.UI.Page
{
    ...
    public void CargaTablaDT()
    {
        ...
        try
        {
            ...
            string qSql = "select ID_CITA, FORMAT(day(FEC_TAR), '00') + '/' + format(month(FEC_TAR), '00') + '/' + cast(year(FEC_TAR) as varchar) Fecha, HOR_TAR Hora, " +
                ...
                "where FEC_TAR>=cast(GETDATE() as date) and CIT_TAR='x' and cast(IFN as date) = @hc and IDNI=@dni " +
