<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ASPX_LoginOptica_Default" %>
         ...
         <div class="login-box-body">
            <p class="login-box-msg">Inicia sesión</p>
               ...
               <div class="form-group has-feedback">
                   <asp:TextBox ID="txtusuario" runat="server" class="form-control" placeholder="Usuario SIPA" required="true"></asp:TextBox>
               ...
               <div class="row">
                  ...
                  <!-- /.col -->
                  <div class="col-xs-4">
                      <asp:LinkButton ID="LBtnPrueba" runat="server" >Regístrate.</asp:LinkButton>
