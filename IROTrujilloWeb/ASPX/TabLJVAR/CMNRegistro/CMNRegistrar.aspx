<%@ Page Language="C#" MasterPageFile="../../MasterPageTabLibres.master" AutoEventWireup="true" CodeFile="CMNRegistrar.aspx.cs" Inherits="ASPX_TabLJVAR_CMNRegistro_CMNRegistrar" %>
...
<script>
    ...
    <script>
        ...
        document.getElementById("LiRegCMN").classList.add('menu-open');
        document.getElementById('UlRegCMN').style.display = 'block';
        document.getElementById("ulRegCMN1").classList.add('active');
        var f = new Date();
