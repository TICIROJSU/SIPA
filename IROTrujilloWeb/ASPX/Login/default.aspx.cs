...
public partial class ASPX_Login_default : System.Web.UI.Page
{
    ...
    protected void enviar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                if (usuario.ToUpper() == "MVASQUEZC" && clave == "73109138")
                {
                    Session["UserName2"] = usuario;
					Session["idUser2"] = "73109138";
					Session["TipoUser"] = "CIEI";
                    logHistorial("CIEI");
                    Session.Timeout = 60;
                    Response.Redirect("../IROJVAR/CIEIMaster/Inicio.aspx");
                }
				else if (usuario.ToUpper() == "TMPSISMED1" && clave.ToUpper() == "TMPSISMED")
				{
					Session["UserName2"] = usuario;
					Session["TipoUser"] = "SISMED";
					logHistorial("SISMED");
					Session.Timeout = 60;
					Response.Redirect("../IROJVAR/SISMED2/DispoPorc.aspx");
				}
				else if (usuario.ToUpper() == "OPTICA" && clave.ToUpper() == "123456")
				{
					Session["UserName2"] = usuario;
					Session["TipoUser"] = "OPTICA";

					Session["idUser2"] = "0";

					logHistorial("SISMED");
					Session.Timeout = 60;
					Response.Redirect("../IROJVAR/Optica/ProcIngresos.aspx");
				}
				else
				{
