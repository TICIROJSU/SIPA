<%@ Page Language="C#" MasterPageFile="../../MasterPagePer.master" AutoEventWireup="true" CodeFile="ListarPersonal2.aspx.cs" Inherits="ASPX_PerIROJVAR_TrabPresencial_ListarPersonal2" %>
   ...
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fPerDet(vDNI, vIDPER, vPersonal) {
            ...
            $.ajax({
                type: "POST", url: "ListarPersonal2.aspx/GetPerDet", data: params, 
        ...
        function fDeletePerDet(vDNI, vIdTrabajo, vFecha) {
            ...
            $.ajax({
                type: "POST", url: "ListarPersonal2.aspx/GetDeletePetDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        document.getElementById("HastaCant").innerHTML = (cantMiliSeg / 24 / 60 / 60 / 1000) + 1;
			...
			<div class="row" style="display:block;">
               <div class="column">
                  ...
                  <div class="col-md-4" >
                     <div class="box-body">
                         <asp:TextBox ID="txtDesde" runat="server" type="date" onchange="fDesdeOK()" class="form-control" ></asp:TextBox>
			...
			<div class="row" style="display:block;">
               <div class="column">
                  ...
                  <div class="col-md-2" >
                    <code>Inc. Lunes <input type="checkbox" id="chkILun" value="Lun" checked="checked" /> </code>
                  </div>
                  <div class="col-md-2" >
                    <code>Inc. Martes <input type="checkbox" id="chkIMar" value="Mar" checked="checked" /> </code>
                  </div>
                  <div class="col-md-3" >
                    <code>Inc. Miercoles <input type="checkbox" id="chkIMie" value="Mie" checked="checked" /> </code>
                  </div>
                  <div class="col-md-2" >
                    <code>Inc. Jueves <input type="checkbox" id="chkIJue" value="Jue" checked="checked" /> </code>
                  </div>
                  <div class="col-md-2" >
                    <code>Inc. Viernes <input type="checkbox" id="chkIVie" value="Vie" checked="checked" /> </code>
                  </div>
...
<script language="javascript" type="text/javascript"> 
	...
	function GPresencialInsert() {
        ...
        $.ajax({
            type: "POST", url: "ListarPersonal2.aspx/SetTipoTrabajoInsert", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
    ...
    function GPresencialInsertVDias() {
        ...
        $.ajax({
            type: "POST", url: "ListarPersonal2.aspx/SetTipoTrabajoInsertVDias", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
            success: function (result) { $("#divErrores").html(result.d) }, 
            error: function(XMLHttpRequest, textStatus, errorThrown) { 
                alert(textStatus + ": " + XMLHttpRequest.responseText); 
    ...
    function GPresencialInsert1Dia() {
        ...
        $.ajax({
            type: "POST", url: "ListarPersonal2.aspx/GetTipoTrabajoInsertValida", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
