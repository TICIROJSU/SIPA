...
public partial class ASPX_IROJVAROptica_Movimientos_Salidas : System.Web.UI.Page
{
    ...
    public static string SetstkProductoAlmacen(string idDestino, string CodProd, string IdProdDet, string Cantidad)
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@tipostk", "Sal");
        ...
        try
        {
            ...
            if (dtDatoDetAt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dbRow in dtDatoDetAt.Rows)
                {
                    ...
                    gHTML += "<td style='text-align: left;' ><input type='number' name='txtCant_" + nroitem + "' id='txtCant_" + nroitem + "' onkeyup='agregaprodKD(" + nroitem + ")' class='form-control input-lg' value='1' /></td>";
                    gHTML += "<td style='text-align: left;' >" +
