<%@ Page Language="C#" MasterPageFile="../../MPOptica.master" AutoEventWireup="true" CodeFile="Salidas.aspx.cs" Inherits="ASPX_IROJVAROptica_Movimientos_Salidas" %>
   ...
   <title>Optica</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function buscarProd() {	
            ...
            $.ajax({
                type: "POST", url: "Salidas.aspx/GetbuscarProd", data: params, 
		...
		function buscarProv() {
            ...
            $.ajax({
                type: "POST", url: "Salidas.aspx/GetbuscarPac", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnNuevo() {
            ...
            $.ajax({
                type: "POST", url: "Salidas.aspx/GetBtnNuevo", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnGuardarCab() {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/SetBtnGuardar", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
		...
		function btnGuardarDet(idming, IDProd, CodMontura, Cantidad, Precio, Importe, IdProdDet) {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/SetBtnGuardarDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoDet(IdProdDet, CodProd, CodMontura, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/SetstkProductoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function ProductosOptica(CodProd, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/SetProductosOptica", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoAlmacen(idDestino, CodProd, IdProdDet, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/SetstkProductoAlmacen", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function buscarNIng() {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/GetNIngresoList", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function gSelNIngDet(vcod) {
			...
			$.ajax({
                type: "POST", url: "Salidas.aspx/GetNIngresoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
...
<script>
    ...
    <script>
        ...
        document.getElementById("liMSalida").classList.add('active');
        var f = new Date();
