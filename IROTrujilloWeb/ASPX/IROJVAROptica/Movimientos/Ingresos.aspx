<%@ Page Language="C#" MasterPageFile="../../MPOptica.master" AutoEventWireup="true" CodeFile="Ingresos.aspx.cs" Inherits="ASPX_IROJVAROptica_Movimientos_Ingresos" %>
   ...
   <title>Optica</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function buscarProd() {
            ...
            $.ajax({
                type: "POST", url: "Ingresos.aspx/GetbuscarProd", data: params, 
		...
		function buscarProv() {
            ...
            $.ajax({
                type: "POST", url: "Ingresos.aspx/GetbuscarPac", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnNuevo() {
			window.location.href = '../../IROJVAROptica/Movimientos/Ingresos.aspx';
		}
		...
		function btnGuardarCab() {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetBtnGuardar", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function btnGuardarDet(idming, IDProd, CodMontura, Cantidad, Precio, Importe, IdProdDet) {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetBtnGuardarDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoDet(IdProdDet, CodProd, CodMontura, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetstkProductoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function ProductosOptica(CodProd, Cantidad) {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetProductosOptica", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function stkProductoAlmacen(idDestino, CodProd, IdProdDet, Cantidad) {
			...
			//
			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetstkProductoAlmacen", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function compruebaIdMontura(nroitem, IDProd) {
			varcodmontura = document.getElementById("txtCodMont_" + nroitem).value;
			var params = new Object();
            params.vCodProd = IDProd;
            params.vCodMontura = varcodmontura;
			params = JSON.stringify(params);

			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetCompruebaMontura", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
					//$("#txtIdMont_" + nroitem).val(result.d);
					document.getElementById("txtIdMont_" + nroitem).value = result.d;
					if (result.d == "0") {
						GeneraIdMontura(IDProd, varcodmontura, nroitem);
					}
				}, 
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": " + XMLHttpRequest.responseText); 
                    $("#divmsj6").html(textStatus + ": " + XMLHttpRequest.responseText);
                }
			});
			document.getElementById("txtPrec_" + nroitem).focus();
			document.getElementById("txtPrec_" + nroitem).select();
		}

		function GeneraIdMontura(IDProd, codmontura, nroitem) {
			var params = new Object();
            params.vCodProd = IDProd;
            params.vCodMontura = codmontura;
			params = JSON.stringify(params);
			//var varIdMontura = "";

			$.ajax({
                type: "POST", url: "Ingresos.aspx/SetGeneraIdMontura", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
					document.getElementById("txtIdMont_" + nroitem).value = result.d;
				}, 
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": " + XMLHttpRequest.responseText); 
					$("#divmsj7").html(textStatus + ": " + XMLHttpRequest.responseText);
					varIdMontura = "-1";
                }
			});
		...
		function buscarNIng() {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/GetNIngresoList", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
		...
		function gSelNIngDet(vcod) {
			...
			$.ajax({
                type: "POST", url: "Ingresos.aspx/GetNIngresoDet", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
				success: function (result) {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Optica - Ingreso de Productos</p>
    </div>
</asp:Content>
					...
					<div class="col-md-4" style="padding:  0px 30px 10px 30px; ">
						<div class="row">
							<div class="col-md-6" style="visibility:hidden">
								...
								<code style="color:black; background-color:transparent">Id Ingreso</code>
							</div>
							<div class="col-md-6" style="visibility:hidden">
								<asp:TextBox ID="txtOrigen" runat="server" class='form-control'>Logistica</asp:TextBox>
								<code style="color:black; background-color:transparent">Alm Origen</code>
								<input type="hidden" id="txtOrigenId" name="txtOrigenId" value="1" />
							</div>
						</div>
						<br />
						<div class="row">
							...
							<div class="col-md-6" style="visibility:hidden">
								<asp:TextBox ID="txtDestino" runat="server" class='form-control'>Tienda</asp:TextBox>
								<code style="color:black; background-color:transparent">Alm Destino</code>
								<input type="hidden" id="txtDestinoId" name="txtDestinoId" value="2" />
							</div>
						</div>
					</div>
				</div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("liMIngreso").classList.add('active');
        var f = new Date();
