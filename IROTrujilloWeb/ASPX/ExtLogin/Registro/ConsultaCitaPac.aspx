<%@ Page Language="C#" MasterPageFile="../../MasterPageExtPac.master" AutoEventWireup="true" CodeFile="ConsultaCitaPac.aspx.cs" Inherits="ASPX_ExtLogin_Registro_ConsultaCitaPac" %>
                  ...
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            ...
                            <code style="font-size:large; background-color:transparent; ">DNI | H.C.</code>
                        </div>
                     </div>
                  </div>
                </div>
