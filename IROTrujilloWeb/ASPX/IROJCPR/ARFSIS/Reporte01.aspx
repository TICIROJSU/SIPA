<%@ Page Language="C#" MasterPageFile="../../MasterPage.master" AutoEventWireup="true" CodeFile="Reporte01.aspx.cs" Inherits="ASPX_IROJCPR_ARFSIS_Reporte01" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <title>IRO - HISMINSA</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DetAtenciones(vdia, vusuario) {
            var params = new Object();
            params.vdia = vdia; 
            params.vusuario = vusuario; 
            params = JSON.stringify(params);

            $.ajax({
                type: "POST", url: "Reporte01.aspx/GetDetAtenciones", data: params, 
        ...
        function DetDx(dat1) {
            ...
            $.ajax({
                type: "POST", url: "Reporte01.aspx/GetDetDx", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fShowProf() {
            ...
            $.ajax({
                type: "POST", url: "Reporte01.aspx/fShowProfesionales", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulASISRep01").classList.add('active');
        var f = new Date();
