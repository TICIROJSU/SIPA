<%@ Page Language="C#" MasterPageFile="../../MasterPageSIPA.master" AutoEventWireup="true" CodeFile="ProgServicios.aspx.cs" Inherits="ASPX_IROJVARSIPA_Programacion_ProgServicios" %>
   ...
   <title>Servicios</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function btnGuardar() {
			...
			params.PSCantTurno = document.getElementById("<%=ddlCantTurnos.ClientID%>").value;
...
<script>
    function fVerCalendarioPer() {
        var vcodSer = document.getElementById("<%=ddlServicio.ClientID%>").value; 
        if (vcodSer == "") {
            alert("Falta Codigo de Servicio");
            return false;
        }
        //location = "ProgPerCalendar.aspx?codPer=" + vcodPer; 
        //window.open("ProgPerCalendar.aspx?codPer=" + vcodPer, "_blank");
        window.open("../../IROJVARSIPA/Programacion/ProSerCalendar.aspx?codPer=" + vcodSer, "_blank");
    }
</script>
            ...
            <div class="row" style="display:block; background-color:#4dd2ff">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="ddlPiso" runat="server" class='form-control text-center' >
             ...
             <div class="row" style="display:block; background-color:#4dd2ff">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="ddlTurno" runat="server" class='form-control text-center' onChange="fHorCupCal()" >
...
<script>
var vM16 = "07:30-07:45-08:00-08:15-08:30-08:45-09:00-09:15-09:30-09:45-10:00-10:15-10:30-10:45-11:00-11:15";
var vM12 = "07:30-07:50-08:10-08:30-08:50-09:10-09:30-09:50-10:10-10:30-10:50-11:10";
var vM08 = "07:30-08:00-08:30-09:00-09:30-10:00-10:30-11:00";
var vM05 = "07:30-08:30-09:30-10:30-11:30";

var vT16 = "01:00-01:15-01:30-01:45-02:00-02:15-02:30-02:45-03:00-03:15-03:30-03:45-04:00-04:15-04:30-04:45";
var vT12 = "01:00-01:20-01:40-02:00-02:20-02:40-03:00-03:20-03:40-04:00-04:20-04:40";
var vT08 = "01:00-01:30-02:00-02:30-03:00-03:30-04:00-04:30";
var vT05 = "01:00-02:00-03:00-04:00-05:00";

    function fHorCupCal() {
        var vCalc = vM05;

        if (document.getElementById("<%=ddlTurno.ClientID%>").value == "M") {
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "16") { vCalc = vM16; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "12") { vCalc = vM12; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "8") { vCalc = vM08; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "5") { vCalc = vM05; }
        }
        if (document.getElementById("<%=ddlTurno.ClientID%>").value == "T") {
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "16") { vCalc = vT16; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "12") { vCalc = vT12; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "8") { vCalc = vT08; }
            if (document.getElementById("<%=txtCupos.ClientID%>").value == "5") { vCalc = vT05; }
        }

        document.getElementById("<%=txtHorario.ClientID%>").value = vCalc;
    }
</script>
                <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <%--<asp:TextBox ID="txtCupos" runat="server" class='form-control text-center' Text="16"></asp:TextBox>--%>
                           <asp:DropDownList ID="txtCupos" runat="server" class='form-control text-center' onChange="fHorCupCal()" >
                ...
                <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtAdiLimite" runat="server" class='form-control text-center' Text="3"></asp:TextBox>
                ...
                <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:DropDownList ID="ddlCantTurnos" runat="server" class='form-control text-center' >
                              <asp:ListItem Value="1">1</asp:ListItem>
                              <asp:ListItem Value="2">2</asp:ListItem>
                              <asp:ListItem Value="3">3</asp:ListItem>
                           </asp:DropDownList>
             ...
             <div class="row" style="display:block; background-color:#4dd2ff">
                ...
                <div class="col-md-8" style="text-align: center;padding:  0px 30px 0px 30px;">
                    ...
                    <div class="input-group margin">
                        <asp:TextBox ID="txtHorario" runat="server" class='form-control' Text="07:30-07:45-08:00-08:15-08:30-08:45-09:00-09:15-09:30-09:45-10:00-10:15-10:30-10:45-11:00-11:15" onFocus="this.select();" ></asp:TextBox>
                    ...
                    <code style="font-size:large; background-color:transparent; ">Horario [01:00-01:15-01:30-02:00-02:30-03:00-03:15-03:20-04:00-04:15-04:30-05:00]</code>
                    </div>
                </div>
                </div>                
             </div>
             ...
             <div class="row" style="display:block; background-color:#4dd2ff">
                <div class="column">
                  <div class="col-md-8" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtObs" runat="server" class='form-control' Text=" "></asp:TextBox>
