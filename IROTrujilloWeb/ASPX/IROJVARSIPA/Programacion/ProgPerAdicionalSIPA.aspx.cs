...
public partial class ASPX_IROJVARSIPA_Programacion_ProgPerAdicionalSIPA : System.Web.UI.Page
{
    ...
    public void CargaCalendario(int vAnio, int vMes, string vMesNom)
    {
        ...
        try
        {
            ...
            for (int i = 1; i <= Days; i++)
            {
                ...
                for (int j = 0; j <= 6; j++)
                {
                    string vDia = "", vDiaHTML = "", vDiaAdiCit = "", vDiaAdiNoCit = "", vDiaCit = "";
                    ...
                    if (diaSemNro == j)
                    {
                        ...
                        vDiaHTML = "<table style='font-size:22px;' class='table-bordered'> " +
                            ...
                            "</td>" +
                            "   <td >" +
                            "       <div class='btn btn-block ' align='center' style = 'background-color: #D29B9F; font-weight:bold;' data-toggle='modal' data-target='#mCitarAdic' onclick=\"fmCitarAdic('" + vFechaFor.ToShortDateString() + "', '" + vDiaAdiCit + "')\"><i class='fa fa-fw fa-calendar-plus-o'></i></div>" +
                            "   </td> " +
                            "</tr> " +
                            "<tr> " +
                            "   <td >" +
