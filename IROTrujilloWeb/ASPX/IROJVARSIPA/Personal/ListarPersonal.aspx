<%@ Page Language="C#" MasterPageFile="../../MasterPageSIPA.master" AutoEventWireup="true" CodeFile="ListarPersonal.aspx.cs" Inherits="ASPX_IROJVARSIPA_Personal_ListarPersonal" %>
...
<script language="javascript" type="text/javascript"> 
    ...
    <script>
        ...
        document.getElementById("LiPersonal").classList.add('menu-open');
        document.getElementById('UlPersonal').style.display = 'block';
        document.getElementById("liPerListar").classList.add('active');
        var f = new Date();
