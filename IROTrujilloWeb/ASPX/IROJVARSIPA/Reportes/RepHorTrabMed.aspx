<%@ Page Language="C#" MasterPageFile="../../MasterPageSIPA.master" AutoEventWireup="true" CodeFile="RepHorTrabMed.aspx.cs" Inherits="ASPX_IROJVARSIPA_Reportes_RepHorTrabMed" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Asignaciones Oftalmologia</p>
    </div>
</asp:Content>
...
<%--                                    <button class="btn btn-default" runat="server" type="button" title="Max.: 3,000 Registros" onserverclick="ExportarExcel_Click">
                                ...
                                <%--tbldscrg--%>
								<button class="btn btn-default" type="button" title="Max.: 1,000 Registros" onclick="exportTableToExcel('tbldsc')"><i class="fa fa-download "></i>
								</button>
                            </div>
                            </h3>
                            <div class="box-tools">
...
<script>
    ...
    <script>
        ...
        document.getElementById("liRepHorTrabMed").classList.add('active');
        var f = new Date();
