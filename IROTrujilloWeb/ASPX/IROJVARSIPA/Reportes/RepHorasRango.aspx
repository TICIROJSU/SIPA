<%@ Page Language="C#" MasterPageFile="../../MasterPageSIPA.master" AutoEventWireup="true" CodeFile="RepHorasRango.aspx.cs" Inherits="ASPX_IROJVARSIPA_Reportes_RepHorasRango" %>
            ...
            <div class="row" style="display:block;">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtfIni" Type="date" runat="server" class='form-control' ></asp:TextBox>
                            <code style="font-size:large; background-color:transparent; ">Fecha Inicial</code>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                            <asp:TextBox ID="txtfFin" Type="date" runat="server" class='form-control' ></asp:TextBox>
                            <code style="font-size:large; background-color:transparent; ">Fecha Final</code>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                          <asp:DropDownList ID="DDLSeguro" runat="server" class='form-control' >
                            <asp:ListItem Value="">Todos</asp:ListItem>
                            <asp:ListItem Value="SIS">SIS</asp:ListItem>
                            ...
                            <asp:ListItem Value="CASO CLINICO">CASO CLINICO</asp:ListItem>
                            <asp:ListItem Value="SALUDPOL">SALUDPOL</asp:ListItem>
                            <asp:ListItem Value="TARGA">TARGA</asp:ListItem>
                            <asp:ListItem Value="CAMPAÑA">CAMPAÑA</asp:ListItem>
                            <asp:ListItem Value="RETINOPATIA DIABETICA">RETINOPATIA DIABETICA</asp:ListItem>
                            <asp:ListItem Value="PROYECCION SOCIAL">PROYECCION SOCIAL</asp:ListItem>
                            <asp:ListItem Value="CONADIS">CONADIS</asp:ListItem>
                            <asp:ListItem Value="CAMPAÑA HTC">CAMPAÑA HTC</asp:ListItem>
                            <asp:ListItem Value="ORBIS">ORBIS</asp:ListItem>
                            <asp:ListItem Value="CUADERNO">CUADERNO</asp:ListItem>
                            <asp:ListItem Value="SIS APOYO DX">SIS APOYO DX</asp:ListItem>
                            <asp:ListItem Value="PARTICULAR APOYO DX">PARTICULAR APOYO DX</asp:ListItem>
                          </asp:DropDownList>
...
<script language="javascript" type="text/javascript"> 
    ...
    <script>
        ...
        document.getElementById("liRepHorasRango").classList.add('active');
        var f = new Date();
