<%@ Page Language="C#" MasterPageFile="../../MPSaludInfantil.master" AutoEventWireup="true" CodeFile="ConvG_FT06.aspx.cs" Inherits="ASPX_SInfantil_ConvG2022_ConvG_FT06" %>
...
<script>
    ...
    function fShowInstitucion() { 
        ...
        $.ajax({ 
            type: "POST", url: "ConvG_FT06.aspx/GetDatoFiltro", data: params, 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Nominal - Convenio de  Gestión FT-06 
            <a class="label label-danger" href="https://datastudio.google.com/u/1/reporting/80196dec-fcb3-43e3-a8e0-8d8dd2d46405/page/p_hdkwvc5i0c" target="_blank"> (Gráfico)</a>
        </p>
    </div>
</asp:Content>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulNomFT06").classList.add('active');
        var f = new Date();
