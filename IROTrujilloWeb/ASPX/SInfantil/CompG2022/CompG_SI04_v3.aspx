<%@ Page Language="C#" MasterPageFile="../../MPSaludInfantil.master" AutoEventWireup="true" CodeFile="CompG_SI04_v3.aspx.cs" Inherits="ASPX_SInfantil_CompG2022_CompG_SI04_v3" %>
...
<script>
    ...
    function fShowInstitucion() { 
        ...
        $.ajax({ 
            type: "POST", url: "CompG_SI04_v3.aspx/GetDatoFiltro", data: params, 
    ...
    function fConsultaPac(vDNI) { 
        ...
        $.ajax({ 
            type: "POST", url: "CompG_SI04_v3.aspx/GetDetAtenciones", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
...
<%--                                    <button class="btn btn-default" type="button" title="Max.: 1,000 Registros" onclick="exportTableToExcel('<%=GVtable.ClientID%>')"><i class="fa fa-download "></i>
    ...
    <script>
        ...
        document.getElementById("ulNomSI04v3").classList.add('active');
        var f = new Date();
