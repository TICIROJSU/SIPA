<%@ Page Language="C#" MasterPageFile="../../MPSaludInfantil.master" AutoEventWireup="true" CodeFile="CompG_SI04_v1.aspx.cs" Inherits="ASPX_SInfantil_Reportes_CompG_SI04_v1" %>
...
<script>
    ...
    function fShowInstitucion() { 
        ...
        $.ajax({ 
            type: "POST", url: "CompG_SI04_v1.aspx/GetDatoFiltro", data: params, 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Nominal - Compromiso de  Gestión SI-04 
            <a class="label label-danger" href="https://datastudio.google.com/u/1/reporting/4f6e62ed-60b0-43dc-a632-b8016a5e64f8/page/p_bzdpdh6b0c" target="_blank"> (Gráfico)</a>
        </p>
    </div>
</asp:Content>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulNomSI04").classList.add('active');
        var f = new Date();
