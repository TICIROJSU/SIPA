<%@ Page Language="C#" MasterPageFile="../../MPSaludInfantil.master" AutoEventWireup="true" CodeFile="RegEquipoSI.aspx.cs" Inherits="ASPX_SInfantil_Registros_RegEquipoSI" %>
...
<script>
    ...
    function fShowInstitucion() { 
        ...
        $.ajax({ 
            type: "POST", url: "RegEquipoSI.aspx/GetDatoFiltro", data: params, 
    ...
    function fShowEESS() { 
        ...
        params.vtxtESHide = ("<%=txtEESSCodHide.ClientID%>"); 
        params.vSel = "EESS"; 
        params = JSON.stringify(params); 

        $.ajax({ 
            type: "POST", url: "RegEquipoSI.aspx/GetDatoFiltroES", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
            success: function (result) { $("#divmodAll").html(result.d) }, 
            error: function(XMLHttpRequest, textStatus, errorThrown) { 
                alert(textStatus + ": " + XMLHttpRequest.responseText); 
    ...
    function fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado) {
        var params = new Object();
        params.vcodES =  vcodES; 
        params.vEquipo = vEquipo; 
        params.vExiste = vExiste; 
        params.vEstado = vEstado; 
        params = JSON.stringify(params);

        $("#divErrores").html("");

        $.ajax({
            type: "POST", url: "RegEquipoSI.aspx/SetRegRefG", data: params, 
            contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
            success: function (result) { $("#divErrores").append(result.d + "<br>") }, 
            error: function(XMLHttpRequest, textStatus, errorThrown) { 
                alert(textStatus + ": " + XMLHttpRequest.responseText); 
                $("#divErrores").append(textStatus + ": " + XMLHttpRequest.responseText);
            }
        });
    }

    function fUpdDispoEquipos() {
        vcodES = document.getElementById("<%=txtEESSCodHide.ClientID%>").value; 
        
        vEquipo = "Hemoglobinometro"; 
        vExiste = document.getElementById("<%=ddlHemogExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlHemogEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Balanza Pediatrica"; 
        vExiste = document.getElementById("<%=ddlBalPExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlBalPEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Tallimetro"; 
        vExiste = document.getElementById("<%=ddlTallPExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlTallPEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Infantometro"; 
        vExiste = document.getElementById("<%=ddlInfanExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlInfanPEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Refrigeradora"; 
        vExiste = document.getElementById("<%=ddlRefriExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlRefriEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Congeladora"; 
        vExiste = document.getElementById("<%=ddlCongeExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlCongePEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "Thermo"; 
        vExiste = document.getElementById("<%=ddlTherExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlTherEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 

        vEquipo = "DataLogger"; 
        vExiste = document.getElementById("<%=ddlDLogExis.ClientID%>").value; 
        vEstado = document.getElementById("<%=ddlDLogEst.ClientID%>").value;
        fUpdDispoEquiposDet(vcodES, vEquipo, vExiste, vEstado); 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Registro de Disponibilidad de Equipos - Salud Infantil 
		  ...
		  document.getElementById("<%=bntBuscar.ClientID%>").click();
             ...
             <div class="row">
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                        <div class="box-body">
                            <label>Hemoglobinometro</label>
                        </div>
                  </div>
                </div>
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlHemogExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  </div>
                </div>
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlHemogEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
                    </select>
                    <code style="color:black; background-color:transparent">Estado</code>
                  </div>
             </div>
             ...
             <div class="row">
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                        <div class="box-body">
                            <label>Balanza Pediatrica</label>
                        </div>
                  </div>
                </div>
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlBalPExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlBalPEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                        <div class="box-body">
                            <label>Tallimetro</label>
                        </div>
                  </div>
                </div>
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlTallPExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlTallPEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                        <div class="box-body">
                            <label>Infantometro</label>
                        </div>
                  </div>
                </div>
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlInfanExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlInfanPEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                ...
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlRefriExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlRefriEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                        <div class="box-body">
                            <label>Congeladora</label>
                        </div>
                  </div>
                </div>
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlCongeExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlCongePEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                ...
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlTherExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlTherEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
             ...
             <div class="row">
                ...
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlDLogExis" class="form-control" runat="server">
	                    <option value="Si">Si</option>
	                    <option value="No">No</option>
                    </select>
                    <code style="color:black; background-color:transparent">Disponible</code>
                  ...
                  <div class="col-md-2" style="text-align: center;">
                    <select id="ddlDLogEst" class="form-control" runat="server">
	                    <option value="Bueno">Bueno</option>
	                    <option value="Regular">Regular</option>
	                    <option value="Malo">Malo</option>
	                    <option value="Malogrado">Malogrado</option>
                ...
                <div class="column" style="display:block">
                  <div class="col-md-2" style="text-align: center;">
                      <button type="button" class="btn bg-navy" onclick="fUpdDispoEquipos()"><i class="fa fa-fw fa-medkit"></i>Guardar Disponibilidad</button>
                  </div>
                </div>
             </div>
