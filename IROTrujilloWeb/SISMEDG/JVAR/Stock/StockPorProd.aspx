<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="StockPorProd.aspx.cs" Inherits="SISMEDG_JVAR_Stock_StockPorProd" %>
   ...
   <title>SISMED - La Libertad</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function fShowProductos() {
            ...
            //params.txtFiltro = document.getElementById("").value; 
            params = JSON.stringify(params);

            $.ajax({
                type: "POST", url: "StockPorProd.aspx/GetMedicamentos", data: params, 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Distribucion por Producto</p>
    </div>
</asp:Content>
            ...
            <div class="row" style="display:block;">
               ...
               <div class="column">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="form-group">
                           <asp:TextBox ID="txtStock" runat="server" class='form-control' ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-12">
                  <div class="box" >
                        <div class="box-header">
                            ...
                            <div class="input-group-btn" style="display:block"><button class="btn btn-default" runat="server" type="button" title="Max.: 3,000 Registros" onserverclick="ExportarExcel_Click"><i class="fa fa-download "></i></button></div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("LiSTOCK").classList.add('menu-open');
        document.getElementById('UlSTOCK').style.display = 'block';
        document.getElementById("ulStockProd").classList.add('active');
        var f = new Date();
