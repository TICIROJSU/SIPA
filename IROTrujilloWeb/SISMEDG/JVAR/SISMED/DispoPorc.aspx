<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="DispoPorc.aspx.cs" Inherits="SISMEDG_JVAR_SISMED_DispoPorc" %>
   ...
   <title>SISMED - La Libertad</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fDetDisponibilidad(Indicador) {
            ...
            params.vHidetipo = document.getElementById("<%=HideTipo.ClientID%>").value; 
            params = JSON.stringify(params);

            $("#divDispo1_2").html("");
            document.getElementById("bscprod").focus();
            document.getElementById("bscprod").value = "";

            $.ajax({
                type: "POST", url: "DispoPorc.aspx/GetDetDisponibilidad", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) {
                    var aResult = result.d.split("||sep||");
                    //$("#divDispo1").html(aResult[1]);
                    $("#divDispo1_2").html(aResult[1]);
                    $("#<%=LitTABL1_1.ClientID%>").html(aResult[0]);
                }, 
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": " + XMLHttpRequest.responseText); 
        ...
        function fShowEESS() {
            $.ajax({
                type: "POST", url: "DispoPorc.aspx/GetEESS",  
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
            ...
            <div class="row" style="display:block;">
                  ...
                  <div class="col-md-3" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="input-group margin">
                            <div class="disabled"><asp:TextBox ID="txtEESS" runat="server" class='form-control'></asp:TextBox></div>
               ...
               <div class="column">
                  <div class="col-md-3" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="input-group margin">
                            <asp:HiddenField ID="HideTipo" runat="server" />
                           <asp:DropDownList ID="DDLTipo" runat="server" class='form-control' AutoPostBack="True" OnSelectedIndexChanged="btnFiltrar_Click">
                              <asp:ListItem Value="" Selected="true">Todos</asp:ListItem>
                              <asp:ListItem Value="Petitorio">Petitorio</asp:ListItem>
                              <asp:ListItem Value="COVID-19">COVID-19</asp:ListItem>
                           </asp:DropDownList>
                            <span class="input-group-btn">
                                <asp:LinkButton ID="btnFiltrar" runat="server" class="btn btn-info" OnClick="btnFiltrar_Click" ><i class="fa fa-search"></i></asp:LinkButton>
                            </span>
                        </div>
...
<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('')" data-toggle="modal" data-target="#modalDispo1">
...
<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('NORMO')" data-toggle="modal" data-target="#modalDispo1">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('SOB-NoAcep')" data-toggle="modal" data-target="#modalDispo1">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('SUB-STK')" data-toggle="modal" data-target="#modalDispo1">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('SIN-ROTACION')" data-toggle="modal" data-target="#modalDispo1">
		<span class="info-box-icon bg-green"><i class="ion ion-stats-bars"></i></span>
		<div class="info-box-content">
...
<div class="row">
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('DESAB')" data-toggle="modal" data-target="#modalDispo1">
		<span class="info-box-icon bg-red"><i class="ion ion-stats-bars"></i></span>
		<div class="info-box-content">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
	  <div class="info-box" onclick="fDetDisponibilidad('No-Consid')" data-toggle="modal" data-target="#modalDispo1">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
		<asp:LinkButton ID="btnDispCovid" runat="server" OnClick="btnDispCovid_Click">
<%--		  <div class="info-box" onclick="fDetDisponibilidad('Covid')" data-toggle="modal" data-target="#modalDispo1">--%>
		  <div class="info-box" >
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulSISMEDRep2").classList.add('active');
        var f = new Date();
