<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="DispBuscaMedxEESS.aspx.cs" Inherits="SISMEDG_JVAR_SISMED_DispBuscaMedxEESS" %>
             ...
             <div class="row">
               ...
               <div class="column">
                  <div class="col-md-4" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <select class='form-control' ID="DDLTipoDispo" runat="server">
                            <option value="" selected disabled hidden>Tipo de Disponibilidad</option>
                            <option value="DESAB">DESAB</option>
                            <option value="SUB-STK">SUB-STK</option>
                            <option value="NORMO">NORMO</option>
                            <option value="SOB-NoAcep">SOB-NoAcep</option>
                            <option value="SIN-ROTACION">SIN-ROTACION</option>
                            <option value="No-Consid">No-Consid</option>
                        </select>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-12">
                  <div class="box" >
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <asp:Label ID="lblRuta" runat="server" Text="" class="form-control"></asp:Label>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulSISMEDBuscaMedxEESS2").classList.add('active');
        var f = new Date();
