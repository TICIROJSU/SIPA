<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="VentasRep.aspx.cs" Inherits="SISMEDG_JVAR_SISMED_VentasRep" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Ventas EESS - SISMED</p>
    </div>
</asp:Content>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulSISMEDVentas").classList.add('active');
        var f = new Date();
