<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="DistriPorDepe.aspx.cs" Inherits="SISMEDG_JVAR_Almacen_DistriPorDepe" %>
   ...
   <title>SISMED - La Libertad</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fShowMRed() {
            ...
            $.ajax({
                type: "POST", url: "DistriPorDepe.aspx/GetMRed", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fShowGR(vMovNumero) {
            ...
            $.ajax({
                type: "POST", url: "DistriPorDepe.aspx/GetGR", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Busqueda por Dependencia</p>
    </div>
</asp:Content>
...
<script>
    ...
    function txtRedCarga(Nombre)
    {
        ...
        document.getElementById("<%=txtMicroRed.ClientID%>").value = ""; 
        document.getElementById("<%=txtEESS.ClientID%>").value = ""; 
        document.getElementById("<%=txtEESSCodHide.ClientID%>").value = ""; 
    }
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulDistriDepe").classList.add('active');
        var f = new Date();
