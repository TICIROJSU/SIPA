<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="DistriPorProd.aspx.cs" Inherits="SISMEDG_JVAR_Almacen_DistriPorProd" %>
   ...
   <title>SISMED - La Libertad</title>
    ...
    <script language="javascript" type="text/javascript">
		...
		function fShowProductos() {
            ...
            $.ajax({
                type: "POST", url: "DistriPorProd.aspx/GetMedicamentos", data: params, 
                ...
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": aj-sh " + XMLHttpRequest.responseText); 
                    $("#divErroresm").html(textStatus + ": " + XMLHttpRequest.responseText);
                }
            });
        }
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulDistriProd").classList.add('active');
        var f = new Date();
