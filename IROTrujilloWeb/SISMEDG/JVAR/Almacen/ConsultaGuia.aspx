<%@ Page Language="C#" MasterPageFile="../../MasterPSISMED.master" AutoEventWireup="true" CodeFile="ConsultaGuia.aspx.cs" Inherits="SISMEDG_JVAR_Almacen_ConsultaGuia" %>
   ...
   <title>GERESA - SISMED</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fShowGR(vMovNumero) {
            ...
            $.ajax({
                type: "POST", url: "ConsultaGuia.aspx/GetGR", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fzipGuiaRem(vMovNumero, vCodEESS, vNumDco) {
            var params = new Object();
            params.vMovNumero = vMovNumero; 
            params.vCodEESS = vCodEESS; 
            params.vNumDco = vNumDco; 
            params = JSON.stringify(params);

            $.ajax({
                type: "POST", url: "ConsultaGuia.aspx/GetzipGuiaRem", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { $("#divcabmsj").html(result.d) }, 
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": " + XMLHttpRequest.responseText); 
                    $("#divcabmsj").html(textStatus + ": " + XMLHttpRequest.responseText);
                }
            });
        }
        ...
        function fShowMRed() {
            ...
            $.ajax({
                type: "POST", url: "ConsultaGuia.aspx/GetMRed", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
        ...
        function fShowEESS() {
            ...
            $.ajax({
                type: "POST", url: "ConsultaGuia.aspx/GetEESS", data: params, 
                contentType: "application/json; charset=utf-8", dataType: "json", async: true, 
                success: function (result) { $("#divEESS").html(result.d) }, 
                error: function(XMLHttpRequest, textStatus, errorThrown) { 
                    alert(textStatus + ": " + XMLHttpRequest.responseText); 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="col-xs-8 col-xs-offset-2">
        <p class="cazador2">Busqueda por Nro de Guia o Pecosa</p>
    </div>
</asp:Content>
            ...
            <div class="row" style="display:block;">
               ...
               <div class="column hide">
                  <div class="col-md-3" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="input-group margin">
                            <asp:TextBox ID="txtDato" runat="server" class='form-control' placeholder="Nro de Guia o Pecosa"></asp:TextBox>
                            <span class="input-group-btn">
                                <div class='btn btn-info btn-flat' data-toggle="modal" data-target="#modalRed">...</div>
                            </span>
                        </div>
               ...
               <div class="column" style="display:none">
                  <div class="col-md-2" style="text-align: center;padding:  0px 30px 0px 30px;">
                     <div class="box-body">
                        <div class="input-group margin">
                            <h2><a onserverclick="Descarga01_Click" runat="server">Descarga01</a></h2>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
    ...
    <script>
        ...
        document.getElementById("ulGuiasRem").classList.add('active');
        var f = new Date();
