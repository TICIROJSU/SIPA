...
public partial class SISMEDG_JVAR_Almacen_DistriPorProd : System.Web.UI.Page
{
	...
	public static string GetMedicamentos(string txtFiltro)
	{
		...
		try
		{
			...
			if (dt.Rows.Count > 0)
			{
				...
				//gDetAtenciones += "<caption>Se muestra un Maximo de 230 Registros, Consulte con mas datos o por el codigo para una mejor busqueda </caption>";
