<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Documentos.aspx.cs" Inherits="ASPXMyS_IROJVAR_Inicio_Documentos" %>
                    ...
                    <form class="form-signin" runat="server">
                        ...
                        <div class="form-group">
                            <h4 class="payslip-title">
                                <strong>
                                    Carga de Documentos de Oficinas o Unidades Funcionales <br /> "IRO JSU" <br /> Periodo 2023-2025
                                </strong>
                            </h4>
                        </div>
                        <div style="text-align:center; color:red"><asp:Label ID="LblMensaje" runat="server" Text=""></asp:Label></div>
                        <div class="form-group">
                            <label>Usuario u Oficina</label>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtClave" runat="server" class="form-control" placeholder="Contraseña" required="true" autofocus="autofocus" Type="password" ></asp:TextBox>
                        </div>
                        <div class="form-group">
