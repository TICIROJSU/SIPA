...
lib.ssMetadata = [
		{name:"Baner_25iroj_atlas_", frames: [[0,0,1024,768],[1026,537,642,309],[0,770,1024,690],[1026,848,520,380],[1574,0,285,303],[1026,0,546,535]]}
];
...
(lib.biometriaoculardiagnosticoprevioacirugiadecataratas = function() {
	this.spriteSheet = ss["Baner_25iroj_atlas_"];
	this.gotoAndStop(0);
...
(lib.Baner_25iro = function(mode,startPosition,loop) {
	...
	// Text1
	this.text = new cjs.Text("La mejor Tecnología...", "italic bold 'Times New Roman'", "#003366");
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/Baner_25iroj_atlas_.jpg", id:"Baner_25iroj_atlas_"}
	],
	preloads: []
};
