                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 dept-tabs-wrap wow fadeInUp animated" data-wow-delay="1s" data-wow-offset="200">
                        ...
                        <div class="tabbable tabs-left">
                            <ul class="nav nav-tabs col-md-4 col-sm-4 col-xs-5">
                                ...
                                <li><a href="#b" data-toggle="tab"><i class="icon-eye-open dept-tabs-icon"></i><span class="tabs-heads">Convoc. CAP D. Leg. 276&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (0)</span><i class="right-arr"></i></a></li>
                                <li><a href="#c" data-toggle="tab"><i class="icon-eye-open dept-tabs-icon"></i><span class="tabs-heads">Convoc. CAS D. Leg. 1057&nbsp;&nbsp;&nbsp;&nbsp;(0) </span><i class="right-arr"></i></a></li>
                                <li><a href="#d" data-toggle="tab"><i class="icon-eye-open dept-tabs-icon"></i><span class="tabs-heads">Locación de Servicio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (1)</span><i class="right-arr"></i></a></li>
                                <!--
	            ...
	            <tbody>           
		            ...
		            ?>
                                ...
                                <div class="tab-pane fade" id="d">
                                    ...
                                    <p style="display:none">* Para cualquier información o consulta adicional pueden escribir al correo <a href="mailto:cotizaciones_iro@yahoo.com">cotizaciones_iro@yahoo.com</a></p>
                                    ...
                                    <p style="display:none">* Los resultados del proceso de selección sólo se publican vía web.</p>
                                    <p style="font-weight: bold; color: #000000">* Los Postulantes deberan enviar la informacion al correo:  <a href="mailto:cotizaciones_iro@yahoo.com">cotizaciones_iro@yahoo.com</a>, o acercarse a la Unidad de Logistica de la Institucion (5to Piso).</p>
                                    <p style="display:none">* Los formatos debidamente llenados deberán ser entregados a la Unidad de Logística.</p>


                                    <p>Descargar FORMATO de Autorización de pago a cuenta CCI >>  <a href="http://www.irotrujillo.gob.pe/files/LS2020/Formato_Auriza_Pago_CCI-2020.docx" target="_blank" class="dept-subtitle-tabs"> DESCARGAR</a></p>
                                    <p>Descargar FORMATO de Declaración Jurada Vinculo Laboral >>  <a href="http://www.irotrujillo.gob.pe/files/LS2020/DECLARACION_JURADA_NO_VINCULO_LABORAL_CON_ESTADO.docx" target="_blank" class="dept-subtitle-tabs"> DESCARGAR</a></p>
                                    ...
                                    <!-- <ul>
                                        <div align="center" style="display:none">
                                        	<div class="dept-subtitle-tabs">2019:</div>
                                            <table width="630" height="320" border="0" align="center" >
                                                <tbody>
                                                    <tr style="border-bottom-color:#FF0000; border-bottom-style:solid; border-bottom-width:1px; border-top-color:#FF0000; border-top-style:solid; border-top-width:1px;">
                                                        <td width="9" height="30" bgcolor="#FFFFB7"><div align="center" vertical-align="middle"><strong><span class="Estilo104"> Proceso</span></strong></div>
                                                        </td>
                                                        <td width="64" bgcolor="#FFFFB7"><div align="center"><strong><span class="Estilo104"> Descripción</span></strong></div>
                                                        </td>
                                                        <td width="10" bgcolor="#FFFFB7"><div align="center"><strong><span class="Estilo104"> Bases</span></strong></div>
                                                        </td>
                                                        <td width="10" bgcolor="#FFFFB7"><div align="center"><strong><span class="Estilo104"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></strong></div>
                                                        </td>
                                                        <td width="9" bgcolor="#FFFFB7"><div align="center"><strong><span class="Estilo104"> Estado</span></strong></div>
                                                        </td>
                                                        < --<td width="9" height="30" bgcolor="#FFFFB7"><div align="center"><strong><span class="Estilo104"> Resultado</span></strong></div>
                                                        </td> ->
                                                    </tr>

													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO </div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">23-12-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div></td>
                                                        <--<td bgcolor="#E9E9E9">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px; visibility: hidden;" ></tr>
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px; visibility: hidden;" ></tr>
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px; visibility: hidden;" ></tr>
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px; visibility: hidden;" ></tr>
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px; visibility: hidden;" ></tr>
                                    ...
                                    <ul>
                                        ...
                                        <div align="center" style="display:block">
                                        	...
                                        	<div class="dept-subtitle-tabs">2020:</div>
                                        	<table width="630" height="320" border="0" align="center" >
                                                <tbody>
                                                    <tr style="border-bottom-color:#FF0000; border-bottom-style:solid; border-bottom-width:1px; border-top-color:#FF0000; border-top-style:solid; border-top-width:1px;">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS-002-001-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO DE ASISTENCIA EN SECRETARIADO - OFICINA DE ADMINISTRACIÓN</div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2020/LOC-PS-002-001-2020.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">21-01-2020 al 22-01-2020</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Activo</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104"><button data-target="#openModal11d" data-toggle="modal" class="btn btn-primary btn-lg"><a href="#openModal11d" style="color:#FF0000;">Ver</a></button></span></strong></div>
                                                        </td>
                                                    </tr>
                                            ...
                                            <table width="630" height="320" border="0" align="center" >
                                                <tbody>
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS439-027-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO ESPECIALIZADO DE OFTALMOLOGIA DE EMERGENCIA - EMERGENCIA</div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-439-27-2019-Emergencia.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">23-12-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS444-026-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO DE ASISTENCIA EN MONITOREO, ANALISIS Y PROCESAMIENTO DE INFORMACION - UNIDAD DE SEGUROS</div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-444-26-2019-Unidad-Seguros.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">20-12-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104"><button data-target="#openModal11d" data-toggle="modal" class="btn btn-primary btn-lg"><a href="#openModal11d" style="color:#FF0000;">Ver</a></button></span></strong></div>
                                                        </td>
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS446-025-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO DE EVALUACIÓN DE PRESTACIÓN DE SERVICIOS DE SALUD - UNIDAD DE SEGUROS</div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-446-25-2019-Unidad-Seguros.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">20-12-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">LOC-PS445-024-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center">SERVICIO DE EVALUACIÓN DE PRESTACIÓN DE SERVICIOS DE SALUD - UNIDAD DE SEGUROS</div></td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-445-24-2019-Unidad-Seguros.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">20-12-2019</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9"><div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div></td>
                                                        <td bgcolor="#E9E9E9">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">LOC-PS435-023-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center">SERVICIO DE APOYO DE ADMINISTRATIVO - DPTO. DE ANESTESIA Y CENTRO QUIRURGICO</div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-435-23-2019-DPTO-ANESTESIA-QUIRUGICO.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">11-12-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">LOC-PS434-022-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center">SERVICIO DE DIGITACION - UNIDAD DE SEGUROS</div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-434-22-2019-Unidad-Seguros.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">11-12-2019</span></strong></div>
                                                        </td>
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">LOC-PS433-021-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center">SERVICIO DE ACTUALIZACION Y COMPLEMENTACION DE PLANOS - OFICINA DE ADMINISTRACION</div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-433-21-2019-OFICINA-ADMINISTRACION.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">11-12-2019</span></strong></div>
                                                        </td>
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">LOC-PS431-020-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center">SERVICIO DE PROFESIONAL Y/O TECNICO EN SISTEMAS/INFORMÁTICA - OFICINA DE ADMINISTRACION</div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-431-20-2019-OFICINA-ADMINISTRACION.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">10-12-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">Finalizado</span></strong></div>
                                                        </td>
													...
													<tr style="border-bottom-color:#000099; border-bottom-style:dashed; border-bottom-width:1px;">
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">LOC-PS430-019-2019</span></strong></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center">SERVICIO DE EVALUACIÓN DE CASOS DE REFERENCIA Y CONTRAREFERENCIA - UNIDAD DE SEGUROS</div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><a href="http://www.irotrujillo.gob.pe/files/LS2019/LOC-PS-430-19-2019-UNIDAD-DE-SEGUROS.zip" target="_blank"><img src="../images/icons/zip-icon.png" alt="" width="30" height="30" style="border:none;box-shadow:none;opacity:0.8;filter:alpha(opacity=80);"></a></div>
                                                        </td>
                                                        <td bgcolor="#E9E9E9">
                                                            <div align="center"><strong><span class="Estilo104">10-12-2019</span></strong></div>
                                                        </td>
