<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HCRegistro.aspx.cs" Inherits="IROTWeb_wPac_Estadistica_HCRegistro" %>
...
<html translate="no">
  ...
  <body>
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Datos Principales</h4>
                      <div class="form-group">
                          <div class="row">
                              <div class="col-md-3">
                                <label for="txtHC">Historia Clinica</label>
                                <input type="text" class="form-control" id="txtHC" placeholder="Historia Clinica">
                                <input type="hidden" id="htxtHC" >
                              </div>
                              <div class="col-md-3">
                                  <label for="chkHC"></label>
                                <div class="form-check form-check-flat form-check-primary">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" id="chkHC"> <i class="input-helper"></i>
                                    </label>
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-md-2">
                                <label for="txtPacDNI">DNI Paciente</label>
                                <input type="text" class="form-control" id="txtPacDNI" placeholder="DNI Paciente">
                              </div>
                              <div class="col-md-3">
                                <label for="txtPacApPat">Apellido Paterno</label>
                                <input type="text" class="form-control" id="txtPacApPat" placeholder="Apellido Paterno">
                              </div>
                              <div class="col-md-3">
                                <label for="txtPacApMat">Apellido Materno</label>
                                <input type="text" class="form-control" id="txtPacApMat" placeholder="Apellido Materno">
                              </div>
                              <div class="col-md-4">
                                <label for="txtPacNomb">Nombres</label>
                                <input type="text" class="form-control" id="txtPacNomb" placeholder="Nombres">
                              </div>
                          </div>
                      ...
                      <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-check">
                                          <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="optSexo" id="optSexoM" value="M"> Masculino <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check">
                                          <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="optSexo" id="optSexoF" value="F"> Femenino <i class="input-helper"></i></label>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" class="form-control" id="txtPacFN" >
                        </div>
                        <div class="col-md-1">
                            <label for="">Edad</label>
                            <input type="text" class="form-control" id="txtPacEdad" placeholder="Edad">
                        </div>
                        <div class="col-md-2">
                            <label for="">Lugar Nac.</label>
                            <input type="text" class="form-control" id="txtPacLugNac" placeholder="Lugar de Nacimiento">
                        </div>
                        <div class="col-md-2">
                            <label for="">Nombre Padre</label>
                            <input type="text" class="form-control" id="txtPacNomPadre" placeholder="Nombre de Padre">
                        </div>
                        <div class="col-md-2">
                            <label for="">Nombre Madre</label>
                            <input type="text" class="form-control" id="txtPacNomMadre" placeholder="Nombre de Madre">
                        </div>
                      </div>
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label>Direccion</label>
                                <input type="text" class="form-control" id="txtPacDir" placeholder="Direccion">
                            </div>
                            <div class="col-md-2">
                                <label>Ubigeo</label>
                                <input type="text" class="form-control" id="txtPacUbigeo" placeholder="Ubigeo">
                            </div>
                            <div class="col-md-2">
                                <label>Tel. Fijo</label>
                                <input type="text" class="form-control" id="txtPacTelFijo" placeholder="Telefono Fijo">
                            </div>
                            <div class="col-md-2">
                                <label>Tel. Celular</label>
                                <input type="text" class="form-control" id="txtPacTelCel" placeholder="Telefono Celular">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" id="txtPacProc" placeholder="Procedencia">
                            </div>
                            <div class="col-md-2">
                                <label>Ocupacion</label>
                                <input type="text" class="form-control" id="txtPacOcup" placeholder="Ocupacion">
                            </div>
                            <div class="col-md-2">
                                <label>Fecha Ingreso</label>
                                <input type="date" class="form-control" id="txtPacFecIng" >
                            </div>
                        </div>
                  ...
                  <div class="card-body">
                      <div class="form-group row">
                          <div class="form-group col">
                              <a href="#" class="btn btn-outline-secondary">!!!!!<br />.....</a>
                          </div>
                          <div class="form-group col">
                              <a href="#" class="btn btn-outline-primary btn-icon-text"><i class="fa fa-file-text"></i></a>
                          </div>
                          <div class="form-group col">
                              <a href="#" class="btn btn-outline-warning btn-icon-text"><i class="fa fa-warning"></i></a>
                          </div>
                    ...
                    <h4 class="card-title">Otros Datos</h4>
                        <div class="form-group row">
                            <div class="col-md-6 row">
                                <div class="col-md">
                                    ...
                                    <select class="form-select" id="cboPacGInstr">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                                <div class="col-md">
                                    <label>Centro Estudios</label>
                                    <input type="text" class="form-control" id="txtPacCEstu" placeholder="Centro de Estudios">
                                </div>
                                <div class="col-md">
                                    <label>Grupo Sanguineo</label>
                                    <select class="form-select" id="cboPacGSang">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                                <div class="col-md">
                                    ...
                                    <select class="form-select" id="cboPacRelig">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 row">
                                <div class="col-md">
                                    ...
                                    <select class="form-select" id="cboPacTSeg">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                                <div class="col-md">
                                    <label>Numero</label>
                                    <input type="text" class="form-control" id="txtPacNume" placeholder="Numero">
                                </div>
                                <div class="col-md">
                                    <label>Estado Civil</label>
                                    <select class="form-select" id="cboPacECivil">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                                <div class="col-md">
                                    ...
                                    <select class="form-select" id="cboPacProg">
                                      <option value=""></option>
                                      <option value="">Opt01</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="cboAcomp">
                                    <option value=""></option>
                                    <option value="">Opt01</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="txtAcompNom" placeholder="Acompañante. Nombres y Apellidos">
                            </div>
                            <div class="col-md-2">
                                <label>DNI</label>
                                <input type="text" class="form-control" id="txtAcompDNI" placeholder="Acompañante. DNI">
                            </div>
                            <div class="col-md-4">
                                <label>Observaciones</label>
                                <input type="text" class="form-control" id="txtObserv" placeholder="Observaciones">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                <label for="chkDiab">Diabetico</label>
                                <div class="form-check form-check-flat form-check-primary">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" id="chkDiab"> <i class="input-helper"></i>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <label>Fecha Actualizacion</label>
                                <input type="date" class="form-control" id="txtFecAct" >
                            </div>
                        </div>
    ...
    <script>
        ...
        txtPacFecIng.max = new Date().toISOString().split("T")[0];
        txtFecAct.max = new Date().toISOString().split("T")[0];
