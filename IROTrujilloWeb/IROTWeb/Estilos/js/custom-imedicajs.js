...
=============================================== */
    ...
    var useGrouping = true;
        ...
        var demo = new countUp('myTargetElement', 0, 1250, 0, 3, options);
        demo.start();
      });
  ...
  $(document).ready(function(){
        $('.counter-style').appear(function(){
        var demo = new countUp('myTargetElement2', 0, 1300, 0, 3, options);
        demo.start();
      });
  ...
  $(document).ready(function(){
        $('.counter-style').appear(function(){
        var demo = new countUp('myTargetElement3', 0, 1350, 0, 3, options);
        demo.start();
      });
  ...
  $(document).ready(function(){
        $('.counter-style').appear(function(){
        var demo = new countUp('myTargetElement4', 0, 1400, 0, 3, options);
        demo.start();
      });
