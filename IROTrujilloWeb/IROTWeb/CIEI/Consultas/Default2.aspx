<%@ Page Language="C#" MasterPageFile="../../MasterPageIRO.master" AutoEventWireup="true" CodeFile="Default2.aspx.cs" Inherits="IROTWeb_CIEI_Consultas_Default" %>
	...
	<div class="col-xs-12 col-lg-12 col-sm-12 col-md-12 " style="background-color: #f8f8f8">
		...
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 " data-wow-delay="0.5s" data-wow-offset="160" style="visibility: visible;-webkit-animation-delay: 0.5s; -moz-animation-delay: 0.5s; animation-delay: 0.5s;">                
			<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad">
				...
				<form class="contact2-page-form col-lg-12 col-sm-12 col-md-12 col-xs-12 no-pad contact-v1" id="contact_formc" method="post" name="formc" runat="server" >
					...
					<div class="col-md-12 control-group">
                        ...
                        <asp:TextBox ID="email" runat="server" class="contact2-textbox" placeholder="Email" required="true" ></asp:TextBox>
					</div>
...
function fileValidation(){
    ...
    if(!allowedExtensions.exec(filePath)){
        alert('Por favor, seleccione unicamente imagenes.');
        fileInput.value = '';
        return false;
    }else{
        //Image preview
        if (fileInput.files && fileInput.files[0]) {
            ...
            reader.readAsDataURL(fileInput.files[0]);
					...
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <asp:fileupload runat="server" ID="file" class="file-input" accept="image/*" required="true" onchange="return fileValidation()"></asp:fileupload>
					</div>
                    <p></p>
					<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                        <asp:LinkButton ID="btnSendMail" runat="server" class="icon-mail btn2-st2 btn-8 btn-8b" OnClick="btnSendMail_Click" > Enviar Correo</asp:LinkButton>
                        <br />
					</div>	
